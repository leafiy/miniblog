<template>
  <div class="VueCarousel">
    <div class="VueCarousel-wrapper" :style="extendWrapperStyle">
    ...
    <pagination v-if="(paginationEnabled && pageCount > 0) && showPagination"></pagination>
...
export default {
  ...
  props: {
    // extend wrapper size for shadow
    extendWrapper: {
      type: Boolean,
      default: false
    },
    /*
    show dotted navigation
    */
    showPagination: {
      type: Boolean,
      default: true
    ...
    /**
     * auto width for each slide wrapper
     */
    autoSlideWidth: {
      type: Boolean,
      default: true
    ...
    /*
    each movement decided by next slide width
    */
    perSlideWidth: {
      type: Number,
      default: 0
  ...
  computed: {
     ...
     */
    // slideCount() {
    //   console.log(this.$slots && this.$slots.default && this.$slots.default.length)
    ...
    slideWidth() {
      ...
      if (this.autoSlideWidth) {
        return width / perPage

      } else if (this.perSlideWidth) {
        return this.perSlideWidth
      } else {
        let count = this.$slots && this.$slots.default && this.$slots.default.length;
